...
class Sp500Test < Minitest::Test
  ...
  def test_sp500_latest_list
    list = Sp500.list(refresh: true)

    assert_equal 505, list.length
  end

  def test_sp500_latest_sectors
    ...
    assert_equal sectors, Sp500.sectors(refresh: true).sort
  end

  def test_sp500_latest_industries
    ...
    assert_equal industries, Sp500.industries(refresh: true)
  end

  def test_sp500_latest_by_sectors
    #pp Sp500.by_sectors
  end
